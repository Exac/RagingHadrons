<style type="text/css" scoped="scoped">
	...
	@font-face {
		...
		font-style: normal;
		font-weight: 600;
		src: url("http://battlelog.battlefield.com/cdnprefix/local/public/base/fonts/purista/PuristaSemibold.woff") format("embedded-opentype"), url("PuristaSemibold.woff") format("woff"), url("PuristaSemibold.ttf") format("truetype"), url("PuristaSemibold.svg#puristasemiboldregular") format("svg"), local("☺");
	}
